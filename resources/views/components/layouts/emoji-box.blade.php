<div class="" x-data="{ open: false }">
    ...
    <div x-show="open" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-20">
        <div @click.away="open = false" class="p-4 bg-SoftBg rounded-lg shadow-xl h-[200px] w-[280px] overflow-scroll"
            id="emojiContainer">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-xl font-bold">Select an Emoji</h2>
                <button wire:click.prevent="" x-on:click="open = false"
