    ...
    <div id="removeMemberInnerModal"
        ...
        <div class="flex flex-col space-y-1 ">
            <div class="px-4 py-3 flex justify-between items-center">
                ...
                <button id="closeModel" class="text-gray-500 w-6 h-6 hover:text-gray-700 text-md focus:outline-none">
                    <x-cross-icon />
                </button>
            </div>
            ...
            <div class="px-4 pt-3">
                <p>Are you sure to remove <span id="memberName"></span> to remove from the  <span id = "workshopName"></span> ?</p>
            </div>
